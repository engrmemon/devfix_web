...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>DEV-FIX TECHNOLOGIES | Software Development</title>
  </head>
            ...
            <ul class="list-js links-list">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">What We Do<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  ...
                  <li class="menu-item sub-menu-item active"><a class="menu-link sub-menu-link  " href="software_development.php">Software Development</a></li>
                  ...
                  <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link  " href="automation.php">Automation</a></li>
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">pages<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  ...
                  <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link  " href="team-member.php">team member</a></li>
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              ...
              <div class="service-content">
                  ...
                  <div class="two-cols-img ">
                    <div class="row">
                      ...
                      <h2 class="service-title">Software Development</h2>
                        <!-- <p class="service-text">Our software development services for website offer end-to-end solutions that cover the entire software development life cycle, from ideation to deployment and maintenance. Our team of experienced developers uses cutting-edge technologies, best practices, and proven methodologies to deliver high-quality and reliable software solutions tailored to meet the unique needs of our clients.</p> -->
                        <p class="service-text"><?php echo $soft_des; ?></p>
                       
                      </div>
                      <div class="col-12 col-md-6">
                      <div class="img-col"><img class="img-fluid" src="assets/images/services/7.png" loading="lazy" alt="service single image "></div>
                ...
                <!-- <div class="part">
                  <h2 class="service-title">Software Development</h2>
                  <p class="service-text" style="text-align: justify;"> Our software development services for website offer end-to-end solutions that cover the entire software development life cycle, from ideation to deployment and maintenance. Our team of experienced developers uses cutting-edge technologies, best practices, and proven methodologies to deliver high-quality and reliable software solutions tailored to meet the unique needs of our clients.</p>
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">Cutting-edge solutions in various domains, such as cloud computing, cybersecurity, and data analytics, to help businesses optimize their operations and gain a competitive edge.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">At our company, we pride ourselves on offering unique solutions to our clients that are tailored to their specific needs and challenges.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">Our strategies are designed to optimize the software development process, increase productivity, and improve the overall quality of the software. </p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
          ...
          <div class="col-12 col-xl-4">
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  <li class="list-item active"><i class="flaticon-web-development font-icon"></i><a href="#1"> Software Development<i class="bi bi-arrow-right icon "></i></a></li>
                  ...
                  <li class="list-item"><i class="flaticon-web-domain font-icon"></i><a href="#0"> Mobile & Development <i class="bi bi-arrow-right icon "></i></a></li>
                  <li class="list-item"><i class="flaticon-profile font-icon"></i><a href="#0"> Graphics Designing<i class="bi bi-arrow-right icon "></i></a></li>
                  <li class="list-item"><i class="flaticon-search font-icon"></i><a href="#0">Digital Agency<i class="bi bi-arrow-right icon "></i></a></li>
                  <li class="list-item"><i class="flaticon-virtual-reality font-icon"></i><a href="#0"> Automation<i class="bi bi-arrow-right icon "></i></a></li>
                  <li class="list-item"><i class="flaticon-medal font-icon"></i><a href="#0"> Training & E-Service<i class="bi bi-arrow-right icon "></i></a></li>
                  <li class="list-item"><i class="flaticon-basic-shapes font-icon"></i><a href="#0"> Tax & Business Consultant<i class="bi bi-arrow-right icon "></i></a></li>
                  <li class="list-item"><i class="flaticon-project-management font-icon"></i><a href="#0"> Event Management & Digital Studio<i class="bi bi-arrow-right icon "></i></a></li>
                </ul>
              </div>
              <!-- <div class="sidebar-pane">
