...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>DEV-FIX TECHNOLOGIES | E-TRAINING </title>
  </head>
            ...
            <ul class="list-js links-list">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">What We Do<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  ...
                  <li class="menu-item sub-menu-item active"><a class="menu-link sub-menu-link  " href="training.php">Training & E-Services</a></li>
                ...
                <div class="part">
                  <div class="two-cols-img ">
                    <div class="row">
                      ...
                      <h2 class="service-title">Training & E-Services</h2>
                        <p class="service-text"><?php echo $training;?></p>
                        <p class="service-text"> </p>
                       
                      </div>
                      <div class="col-12 col-md-6">
                      <div class="img-col"><img class="img-fluid" src="assets/images/services/train1.png" loading="lazy" alt="service single image "></div>
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">Cloud computing, Mobile learning,Artificial Intelligence (AI) and Machine Learning (ML)
                            these latest technologies are transforming the way training and
                             e-services are delivered, making them more engaging, interactive, and accessible to a wider audience.
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-medal font-icon"></i><a href="#0"> Training & E-Service<i class="bi bi-arrow-right icon "></i></a></li>
