...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Dev-FIX TECHNOLOGIES | Mobaile & Development</title>
  </head>
            ...
            <ul class="list-js links-list">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">What We Do<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  ...
                  <li class="menu-item sub-menu-item active"><a class="menu-link sub-menu-link  " href="mobile_dev.php">Mobile & Development</a></li>
                  ...
                  <div class="two-cols-img ">
                    <div class="row">
                      ...
                      <h2 class="service-title">Mobile Development</h2>
                        <p class="service-text"><?php echo $mobile_dev;?></p>
                        <p class="service-text"> </p>
                       
                      </div>
                      <div class="col-12 col-md-6">
                      <div class="img-col"><img class="img-fluid" src="assets/images/services/agency2.png" loading="lazy" alt="service single image "></div>
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-web-domain font-icon"></i><a href="#3"> Mobile & Development <i class="bi bi-arrow-right icon "></i></a></li>
