...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title> DEV-FIX TECHNOLOGIES   |   404 - Page Not Found</title>
  </head>
  <body class=" dark-theme ">
    ...
    <section class=" err-404 d-flex align-items-center">
      <div class="overlay-photo-image-bg " data-bg-img="assets/images/sections-bg-images/404.jpg" data-bg-opacity=".35"></div>
      <div class="container">
        <div class="row">
