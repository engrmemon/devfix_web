...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>DEV-FIX TECHNOLOGIES | Graphics Designing</title>
  </head>
            ...
            <ul class="list-js links-list">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">What We Do<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  ...
                  <li class="menu-item sub-menu-item active"><a class="menu-link sub-menu-link  " href="graphics.php">Graphics Designing</a></li>
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              ...
              <div class="service-content">
                ...
                <div class="part">
                  <div class="two-cols-img ">
                    <div class="row">
                      ...
                      <h2 class="service-title">Graphics Designing</h2>
                      ...
                      <div class="col-12 col-md-6">
                        <div class="img-col"><img class="img-fluid" src="assets/images/services/graphics.png" loading="lazy" alt="service single image "></div>
                      </div>
                    </div>
                  </div>
                </div>
                <!-- <div class="part">
                  <h2 class="service-title">Graphics Designing</h2>
                  <p class="service-text" style="text-align: justify;">Graphic design services are used by businesses of all sizes and in various industries to create branding materials, marketing collateral, and other visual content. Our services are designing logos, websites, marketing materials, advertisements, and other types of visual content.</p>
                  <p class="service-text"> </p>
                </div> -->
                <div class="part">
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">Cutting-edge solutions in various domains, such as adobe photoshope, Adobe Illustrare, to help to create branding materials, marketing collateral, and other visual content.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">Our strategie is to understanding the client's requirements and objectives, conducting research on the target audience and competition, and creating a design that aligns with the client's brand identity and message. </p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-profile font-icon"></i><a href="#4"> Graphics Designing<i class="bi bi-arrow-right icon "></i></a></li>
