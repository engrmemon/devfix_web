...
$sql = "SELECT service_des FROM service";
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            $dig_agency_des=$row["service_des"];
        }
    } else {
        echo "0 results";
    }
...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>DEV-FIX TECHNOLOGIES | Digital Agency</title>
  </head>
            ...
            <ul class="list-js links-list">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">What We Do<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  ...
                  <li class="menu-item sub-menu-item active"><a class="menu-link sub-menu-link  " href="digital_agency.php">Digital Agency</a></li>
                  ...
                  <div class="two-cols-img ">
                    <div class="row">
                      <div class="col-12 col-md-6 mb-3">
                        <h2 class="service-title">Digital Agency</h2>
                        <p class="service-text">
                        <?php echo $dig_agency_des;?>
                        </p>
                        <p class="service-text"> </p>
                        <!-- <div class="img-col"><img class="img-fluid" src="assets/images/services/agency6.png" loading="lazy" alt="service single image "></div> -->
                      </div>
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-search font-icon"></i><a href="#5">Digital Agency<i class="bi bi-arrow-right icon "></i></a></li>
