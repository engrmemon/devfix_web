...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title> DEV-FIX TECHNOLOGIES | Career</title>
  </head>
            ...
            <ul class="list-js links-list">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">pages<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  ...
                  <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link   active" href="team-member.php">team member</a></li>
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Career</h1>
        ...
        <div class="row">
          <div class="col-12 col-lg-9">
            <div class="tm-description">
              <h3 class="tm-title">Career</h3>
              <p class="tm-text">As a member of our team, you'll have the opportunity 
                to work on exciting projects for a variety of clients, using the latest 
                tools and technologies. You'll collaborate with other talented professionals 
                to design and develop websites that meet the unique
                 needs of our clients, while ensuring they are visually stunning, user-friendly, 
              ...
              <h3 class="tm-title">Skills we required</h3>
              <div class="skills">
                <div class="skill">
              ...
              <h3 class="tm-title">Some requirement </h3>
              <ul class="tm-list  ">
          ...
          <div class="col-12  col-lg-3 mx-auto ">
            <div class="profile ">
              <div class="tm-img  "><img class=" img-fluid " loading="lazy" src="assets/images/portfolio/1.png" alt="Team Member"></div>
