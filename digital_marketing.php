...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>D-FIX TECHNOLOGIES</title>
  </head>
            ...
            <ul class="list-js links-list">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">What We Do<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  ...
                  <li class="menu-item sub-menu-item active"><a class="menu-link sub-menu-link  " href="digital_marketing.php">Digital Marketing</a></li>
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              ...
              <div class="service-content">
                ...
                <div class="part">
                  <div class="two-cols-img ">
                    <div class="row">
                      ...
                      <p class="service-text" style="text-align: justify;"> <?php echo $dig_mar_des;?>
                      </p>
                      ...
                      <div class="col-12 col-md-6">
                        <div class="img-col"><img class="img-fluid" src="assets/images/services/auto_1.png" loading="lazy" alt="service single image "></div>
                      </div>
                    </div>
                  </div>
                </div>
                <!-- <div class="part">
                  <h2 class="service-title">Digital Marketing</h2>
                  <p class="service-text" style="text-align: justify;"> Digital marketing services refer to the various strategies and techniques used by businesses to promote their products or services online. This can include activities such as website design and development, search engine optimization (SEO), pay-per-click (PPC) advertising, social media marketing, email marketing, content creation, and analytics tracking.</p>
                  <p class="service-text"> </p>
                </div> -->
                <div class="part">
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-nanotechnology font-icon"></i><a href="#2"> Digital Marketing<i class="bi bi-arrow-right icon "></i></a></li>
                  ...
                  <li class="list-item"><i class="flaticon-virtual-reality font-icon"></i><a href="#6"> Automation<i class="bi bi-arrow-right icon "></i></a></li>
