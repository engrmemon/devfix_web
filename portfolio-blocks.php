...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title> DEV-FIX TECHNOLOGIES   |   Portfolio</title>
  </head>
        ...
        <nav class="menu-navbar">
          ...
          <div class="links menu-wrapper ">
            <ul class="list-js links-list">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link   active" href="#0">portfolio <i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
    ...
    <section class="portfolio portfolio-blocks mega-section   " id="portfolio">
      <div class="container">
        <div class="sec-heading  ">
          ...
          <div class=" cta-area   wow fadeInUp" data-wow-delay=".8s"><a class="cta-btn btn-solid    " href="portfolio-blocks.html">see more <i class="bi bi-arrow-right icon "></i></a></div>
        </div>
        <div class="portfolio-wrapper  ">
          ...
          <div class="portfolio-group wow fadeIn" data-wow-delay=".4s">
            <div class="row  ">
              <div class="col-12  col-lg-6  portfolio-item mobile ">
              ...
              <div class="col-12  col-lg-6  portfolio-item data ">
                <div class="item   "><a class="portfolio-img-link" href="portfolio-single.html"><img class="portfolio-img   img-fluid " loading="lazy" src="assets/images/portfolio/7.jpg" alt="portfolio item photo"/></a>
                  <div class="item-info ">
                    <h3 class="item-title">other category</h3><i class="bi bi-arrow-right icon "></i>
                  </div>
                </div>
              </div>
              <div class="col-12   col-lg-7  portfolio-item mobile ">
              ...
              <div class="col-12  col-lg-5  portfolio-item web">
              ...
              <div class="col-12  col-lg-4  portfolio-item web">
              ...
              <div class="col-12  col-lg-4  portfolio-item mobile ">
              ...
              <div class="col-12  col-lg-4  portfolio-item hosting ">
