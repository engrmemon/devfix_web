...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title> DEV-FIX TECHNOLOGIES   |   About Us</title>
  </head>
  <body class=" dark-theme ">
        ...
        <nav class="menu-navbar">
          ...
          <div class="links menu-wrapper ">
            <ul class="list-js links-list">
              ...
              <li class="menu-item"><a class="menu-link   active" href="about-us.php">Our Company</a></li>
          ...
          <div class="controls-box">
            ...
            <!--mini shoping cart-->
            <!-- <div class=" cta-area wow fadeInUp" style="position:relative; left:25px;"><a class="cta-btn btn-solid" href="login.php">Log in<i class="bi bi-arrow-right icon "></i></a></div> -->
          </div>
        </nav>
      </div>
    </header>
            ...
            <div class="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end  wow fadeInUp " data-wow-delay="0.6s">
              <div class="text-area ">
                <div class="sec-heading  light-title ">
                  <div class="content-area"><span class=" pre-title       wow fadeInUp " data-wow-delay=".2s">Our Company</span>
                    <h2 class=" title    wow fadeInUp" data-wow-delay=".4s"><span class='hollow-text'>Registered</span> by <span class='featured-text'>SECP & FBR 
                ...
                <p class=" about-text">
                At DEV-FIX, we believe in the power of technology to transform the way companies operate 
                and compete in today's digital world. Our team of experienced developers, designers, and project
                 managers work closely with clients to understand their unique needs and develop customized software 
                 solutions that help them achieve their goals.
                
                  
                </p>
                
                <div class="cta-area"><a class=" btn-solid reveal-start" href="contact-us.php">Get in touch</a>
                  <div class="signature ">Nabeel Ahmed
                    <!-- <div class="signature-img"></div> -->
                    <div class="signature-name">Director, Operations & Development</div>
                  </div>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
              <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.1s">
                <div class="tm-image js-tilt "><a class="tm-link  " href="career.php"> 
                    <div class="overlay overlay-color"></div>
                    <img class="img-fluid parallax-img  " loading="lazy" src="assets/images/our-team/t3.png" alt="Team Member"/></a>
                  <!-- <div class="tm-social">
                ...
                <div class="tm-details"><a class="tm-link" href="career.php"> 
                    <h6 class="tm-name">Engr.Nabeel Ahmed</h6></a><span class="tm-role">Director, Operations & Development   </span></div>
              </div>
            </div>
            <!--Second Team Member-->
            <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
              <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="tm-details"><a class="tm-link" href="career.php"> 
                    <h6 class="tm-name">Engr. Muhammad Riaz</h6></a><span class="tm-role">Director, IT & R&D </span></div>
              </div>
            </div>
            <!--Third Team Member-->
            <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
              <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.4s">
                ...
                <div class="tm-details"><a class="tm-link" href="career.php"> 
                    <h6 class="tm-name">Muhammad Usman</h6></a><span class="tm-role">Director, Sales & Services</span></div>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="testmonial-card d-flex align-items-center justify-content-center">
                    <div class="testimonial-content">
                      <div class="customer-img ">
                        <img class="img-fluid " loading="lazy" src="assets/images/testimonials/1.png" alt="First Slide "></div>
                      <div class="customer-testimonial">
                        <div class="content">
                          <p class="testimonial-text ">I'm proud to say that we have a team of dedicated professionals 
                            who work tirelessly to ensure that our customers have the best experience possible. From our sales 
                            team to our customer service representatives, everyone at Dev-FIX is committed to delivering excellence.</p>
                        </div>
                      </div>
                      <div class="customer-info ">
                        <div class="customer-details">
                          <p class="customer-name">Engr Nabeel Ahmed</p>
                          <p class="customer-role">Director, Operations & Development</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="testmonial-card d-flex align-items-center justify-content-center">
                    <div class="testimonial-content">
                      ...
                      <div class="customer-info ">
                        <div class="customer-details">
                          <p class="customer-name">Engr Muhammad Riaz Ali</p>
                          <p class="customer-role">Director, IT & R&D </p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="testmonial-card d-flex align-items-center justify-content-center">
                    <div class="testimonial-content">
                      ...
                      <div class="customer-info ">
                        <div class="customer-details">
                          <p class="customer-name">Muhammad Usman</p>
                          <p class="customer-role">Director, Sales & Services</p>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <section class="take-action elf-section has-dark-bg" id="take-action">
      <div class="overlay-photo-image-bg  " data-bg-img="assets/images/sections-bg-images/pattern-bg-3.jpg" data-bg-opacity=".25"> </div>
