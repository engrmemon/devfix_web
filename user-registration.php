...
<link href="assets_login/css/phppot-style.css" type="text/css"
	rel="stylesheet" />
<link href="assets_login/css/user-registration.css" type="text/css"
	rel="stylesheet" />
...
.sign-up-container{
  ...
  /* background-image: linear-gradient(to right, blue,#0D141F); */
}
.form-label{
