...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>DEV-FIX TECHNOLOGIES | Event Management</title>
  </head>
            ...
            <ul class="list-js links-list">
              ...
              <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">What We Do<i class="fas fa-plus  plus-icon"> </i></a>
                <ul class="sub-menu ">
                  ...
                  <li class="menu-item sub-menu-item active"><a class="menu-link sub-menu-link  " href="event_mgt.php">Event Management & Digital Studio</a></li>
                  <!-- <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link  " href="services.php">services</a></li>
                ...
                <div class="part">
                  <div class="two-cols-img ">
                    <div class="row">
                      ...
                      <h2 class="service-title">Event Management & Digital Studio</h2>
                       <p class="service-text"> 
                       <?php echo $event_mgt_des; ?>
                      </p>
                      ...
                      <div class="col-12 col-md-6">
                        <div class="img-col">
                          <img class="img-fluid" src="assets/images/services/event2.png" loading="lazy" alt="service single image "></div>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">We provide a range of features and tools, such as live streaming,
                               interactive sessions, chat functions, and virtual networking,
                               that make it possible to create engaging and interactive events that are accessible to a wider audience</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-project-management font-icon"></i><a href="#9"> Event Management & Digital Studio<i class="bi bi-arrow-right icon "></i></a></li>
                </ul>
              </div>
              <!-- <div class="sidebar-pane">
