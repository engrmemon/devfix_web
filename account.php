...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title> DEV-FIX TECHNOLOGIES   |   Account</title>
  </head>
  <body class=" dark-theme ">
        ...
        <nav class="menu-navbar">
          ...
          <div class="links menu-wrapper ">
            <ul class="list-js links-list">
              ...
              <li class="menu-item"><a class="menu-link   active" href="account.php">account</a></li>
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Your Account</h1>
    ...
    <div style="background-color:aliceblue;padding:100px;color:black">
  <h4>Welcome to D-fix <?php echo $username;?></h4>
  <p>
    ...
    <div class=" cta-area wow fadeInUp"><a class="cta-btn btn-solid" href="logout.php">Logout<i class="bi bi-arrow-right icon "></i></a></div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
              <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.1s">
                <div class="tm-image js-tilt "><a class="tm-link  " href="career.html"> 
                ...
                <div class="tm-details"><a class="tm-link" href="career.html"> 
